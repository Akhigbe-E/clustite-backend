...
INSERT into commitment_groups (owner_id, group_name, group_type, group_joining_code,number_of_clusters, commitment_name, commitment_description, stake, has_given_reward ) values ('1', 'Spetnaz Squad', 'Private', 'XQ34TANGO',2, 'CSC 424 Test 1', 'Lorem Ipsum', 3000, false);
...
INSERT into clusters (commitment_group_ID, cluster_name, cluster_score, reward) values(1,'Alpha Cluster', 100, 0);
INSERT into clusters (commitment_group_ID, cluster_name, cluster_score, reward) values(1,'Beta Cluster', 70, 0);
